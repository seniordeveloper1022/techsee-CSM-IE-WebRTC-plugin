========================================================================
    ACTIVE TEMPLATE LIBRARY : WebRTCPlugin Project Overview
========================================================================

AppWizard has created this WebRTCPlugin project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

WebRTCPlugin.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

WebRTCPlugin.vcxproj.filters
...
WebRTCPlugin.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (WebRTCPlugin.h)
        GUID definitions                                (WebRTCPlugin_i.c)
        A type library                                  (WebRTCPlugin.tlb)
        Marshaling code                                 (WebRTCPlugin_p.c and dlldata.c)

WebRTCPlugin.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in WebRTCPlugin.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named WebRTCPlugin.pch and a precompiled types file named StdAfx.obj.
...
WebRTCPluginps.vcxproj
	...
	dlldata.c, WebRTCPlugin_i.c and WebRTCPlugin_p.c which are required
	to build the proxy/stub DLL.

WebRTCPluginps.vcxproj.filters
